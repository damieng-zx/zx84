...
vi.mock('@/store/settings.ts', () => ({ renderer: vi.fn(() => 'canvas'), webglAvailable: vi.fn(() => false), setWebglAvailable: vi.fn(), setRenderer: vi.fn(), persistSetting: vi.fn(), borderSize: vi.fn(() => 2), colorMap: vi.fn(() => 'measured'), scale: vi.fn(() => 2), brightness: vi.fn(() => 0), contrast: vi.fn(() => 50), smoothing: vi.fn(() => 0), curvature: vi.fn(() => 0), scanlines: vi.fn(() => 0), maskType: vi.fn(() => 0), dotPitch: vi.fn(() => 10), curvatureMode: vi.fn(() => 0), noise: vi.fn(() => 0), scalingMode: vi.fn(() => 0), volume: vi.fn(() => 70), ayMix: vi.fn(() => 50), tapeInstantLoad: vi.fn(() => true), tapeTurbo: vi.fn(() => true), tapeSoundEnabled: vi.fn(() => true), scanlineAccuracy: vi.fn(() => 'high'), ayStereo: vi.fn(() => 'ABC'), ayDcBlock: vi.fn(() => true), writeProtectA: vi.fn(() => false), writeProtectB: vi.fn(() => false), driveBForceReady: vi.fn(() => false), vtx5000Enabled: vi.fn(() => false), multifaceEnabled: vi.fn(() => false), plus3V41Roms: vi.fn(() => false), tapeAutoRewind: vi.fn(() => true), setTapeAutoRewind: vi.fn() }));
...
vi.mock('@/plus3/dsk.ts', () => ({ parseDSK: vi.fn(() => ({ tracks: [] })), serializeDSK: vi.fn(() => new Uint8Array()) }));
