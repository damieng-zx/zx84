...
const ZX80_LEGENDS: Record<string, Legend> = {
  ...
  '0': { capFn: 'RUBOUT' },
  Q: { keyword: 'NEW', graphic: GREY },
  W: { keyword: 'LOAD', graphic: GREY },
  E: { keyword: 'SAVE', graphic: GREY },
  R: { keyword: 'RUN', graphic: GREY },
  T: { graphic: GREY }, // UNCERTAIN: source shows no K-mode keyword on T
  Y: { keyword: 'REM', shift: '"' },
  U: { keyword: 'IF', shift: '$' },
  ...
  S: { keyword: 'STOP', graphic: GREY },
  D: { keyword: 'DIM', graphic: GREY },
  F: { keyword: 'FOR', graphic: GREY },
  G: { keyword: 'GO TO', graphic: GREY },
  H: { keyword: 'POKE', shift: '**' },
  J: { keyword: 'RANDOMISE', shift: '−' },
  K: { keyword: 'LET', shift: '+' },
  L: { shift: '=' },
  Z: { shift: ':' },
