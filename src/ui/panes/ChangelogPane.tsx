...
const CHANGELOG: { version: string; items: string[] }[] = [
  {
    ...
    items: [
      ...
      'SAM Coupé: BEEP and RAINBOW no longer light for a held key — port 0xFE is the border, beeper and cassette MIC at once, and the ROM writes it on every auto-repeat',
